...
class TopRatedTvSeries {
  ...
  factory TopRatedTvSeries.fromRawJson(String str) => TopRatedTvSeries.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TopRatedTvSeries.fromJson(Map<String, dynamic> json) => TopRatedTvSeries(
    page: json["page"],
