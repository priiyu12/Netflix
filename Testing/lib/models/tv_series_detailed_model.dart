...
class TvSeriesDetailedModel {
  ...
  TvSeriesDetailedModel copyWith({
    bool? adult,
    String? backdropPath,
    List<CreatedBy>? createdBy,
    List<int>? episodeRunTime,
  ...
  factory TvSeriesDetailedModel.fromRawJson(String str) => TvSeriesDetailedModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TvSeriesDetailedModel.fromJson(Map<String, dynamic> json) => TvSeriesDetailedModel(
    adult: json["adult"],
