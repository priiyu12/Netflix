...
class _IntroVideoScreenState extends State<IntroVideoScreen> {
  ...
  Future<void> _initializeVideo() async {
    _controller = VideoPlayerController.asset('assets/SHOWBOX.mp4') // PATH OF VIDEO TO LOAD
      ..initialize().then((_) {
        setState(() {
  ...
  void _navigateToLogin() {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => const LoginScreen()), //NEVIGATE TO LOG IN SCREEN
    );
  }
