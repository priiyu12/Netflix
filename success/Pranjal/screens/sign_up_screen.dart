...
import 'about_us_screen.dart'; // Import the AboutUsPage
                    ...
                    children: [
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const AboutUsScreen()), // Navigate to About Us page
                          );
                        },
                        child: const Text(
                          'About Us',
                          style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold), // Make the text bold and white
                        ),
                      ),
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => const HelpPage()), // Navigate to Help page
                          );
                        },
                        child: const Text(
                          'Help',
